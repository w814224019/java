...
import com.wuliu.fa.entity.HttpUtil;
import com.wuliu.fa.entity.PayResult;
import com.wuliu.fa.entity.PreOrder;
import com.wuliu.fa.entity.PreOrderResult;
import com.wuliu.fa.entity.Sign;
import com.wuliu.fa.entity.XmlUtil;
...
public class WxOrderServiceImpl implements WxOrderService {
	...
	public PreOrderResult placeOrder(String body, String out_trade_no, String total_fee) throws Exception {
		...
		o.setSpbill_create_ip(WeChatConfig.SPBILL_CREATE_IP1);
		...
		p.put("spbill_create_ip", WeChatConfig.SPBILL_CREATE_IP1);
		p.put("notify_url", WeChatConfig.NOTIFY_URL);
		p.put("trade_type", WeChatConfig.TRADE_TYPE);
		// 获得签名
		String sign =  WXPayUtil.generateSignature(p, WeChatConfig.KEY);
		o.setSign(sign);
		// Object转换为XML
		...
		// 打印微信支付订单详情
			System.out.println("打印微信订单："+preOrderResult.toString());
