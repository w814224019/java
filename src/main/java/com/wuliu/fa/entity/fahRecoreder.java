...
public class fahRecoreder implements Serializable {
	...
	public String toString() {
		return "fahRecoreder [id=" + id + ", fhuser=" + fhuser + ", fhphone=" + fhphone + ", fhaddress=" + fhaddress
				+ ", xian1=" + xian1 + ", fhaddress1=" + fhaddress1 + ", shuser=" + shuser + ", shphone=" + shphone
				+ ", shaddress=" + shaddress + ", shaddress1=" + shaddress1 + ", goodsname=" + goodsname + ", goodsnum="
				+ goodsnum + ", weight=" + weight + ", volume=" + volume + ", time=" + time + ", chetype=" + chetype
				+ ", chang=" + chang + ", remark=" + remark + ", companyId=" + companyId + ", compname=" + compname
				+ ", tracking=" + tracking + ", userid=" + userid + ", status=" + status + ", timeout=" + timeout
